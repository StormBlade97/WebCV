...
const Achievement = props => (
    <AchievementContainer>
        <StrongText primary>{props.title}</StrongText>
        <Text light>{props.content}</Text>
    </AchievementContainer>
);
...
const Education = props => (
    <Container>
        <Header style={{ marginBottom: '46px' }} main={'EDUCATION & '} mainColored={'ACHIEVEMENT '} color="white" />
        <ResponsiveGrid style={{ paddingLeft: '2em', paddingRight: '2em' }} container>
            <ResponsiveGrid item md={3} sm={12} xs={12}>
                <Text style={{ whiteSpace: 'breakword' }}>
                    I have had relevant background in Software Engineering. Currently, I am studying at Metropolia UAS
                    3rd year.
                </Text>
            </ResponsiveGrid>

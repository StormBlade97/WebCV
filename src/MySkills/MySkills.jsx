                ...
                <Grid container style={{ minHeight: '400px' }}>
                    <TextBox item lg={5} md={12} sm={12} xs={12}>
                        ...
                        <Text justify normal color={colors.grey[800]}>
                            I have hands on experience designing and developing application of different scales. At my
                            current company I helped prototyping and implementing a data curation tool. The tool is
                            expected to handle very large data sets, usually around tens of thoudsands of rows and
                            hundreds of columns, while allowing user to interact and manipulate the dataset in a
                            spreadsheet way (with infinite grid), like Microsoft Excel. It's a huge engineering feat,
                            and contrary to contemporary solution, it comes with Material Design. It is praised to be
                            the company's flagship in terms of UI. <br />
                            Besides work experience, I also have a handful of school projects and own projects. You can
                            check them out in the Experience section.
                        </Text>
                    </TextBox>

    ...
    render() {
        return (
            <div style={{ alignSelf: 'flex-start', width: '100%', maxWidth: 1300, padding: 12 }}>
                ...
                <br />
                <Text normal light color={darkColor}>
                    Send me an email, give me a call, or connect with me if you are interested
                </Text>
                    ...
                    <Grid item sm={6} xs={12}>
                        {contacts.map((contact, key) => (
                            <ListItem
                                ...
                                key={key}
                                leftIcon={
                                    <Icon animate={false} color={darkColor} iconClassName={`fa fa-${contact.medium}`} />
                                }
                                title={contact.title}
